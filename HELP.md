...
* The original package name 'io.github.toquery.example-spring-graphql' is invalid and this project uses 'io.github.toquery.examplespringgraphql' instead.
...
```
$ docker run --rm -p 8080:8080 example-spring-graphql:0.0.1-SNAPSHOT
```
